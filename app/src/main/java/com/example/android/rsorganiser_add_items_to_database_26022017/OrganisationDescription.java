...
public class OrganisationDescription extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        organisationPosition = (bundle.getInt("position"));
    ...
    private void displayEventDescription() {
        ...
        String[] projection = {
                ...
                OrganisationsContract.OrganisationEntry.COLUMN_ORGANISATION_DESCRIPTION,
        ...
        Cursor cursor = db.query(
                ...
                OrganisationsContract.OrganisationEntry._ID + "=?",      //Columns for the where clause
                new String[]{("" + organisationPosition)},                            //Values for the where clause
        ...
        try {
            ...
            int descriptionColumnIndex = cursor.getColumnIndex(OrganisationsContract.OrganisationEntry.COLUMN_ORGANISATION_DESCRIPTION);
    ...
    public void deleteEvent(String id) {
        ...
        try {
            db.delete(OrganisationsContract.OrganisationEntry.TABLE_NAME, "_ID = ?", new String[] {id});
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            db.close();
